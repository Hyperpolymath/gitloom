...
:experimental:
:url-github: https://github.com/hyperpolymath/gitloom
:url-gitlab: https://gitlab.com/hyperpolymath/gitloom
:url-bitbucket: https://bitbucket.org/hyperpolymath/gitloom
:url-codeberg: https://codeberg.org/hyperpolymath/gitloom
...
gitloom is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
